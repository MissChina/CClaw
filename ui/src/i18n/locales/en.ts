...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    palette: {
      ...
      shellDescription: "Run shell",
      debugLabel: "Debug Mode",
      debugDescription: "Toggle debug",
      categories: {
        search: "Commands",
  ...
  chat: {
    ...
    welcomeSuggestionHealth: "Check system health",
    searchPlaceholder: "Search messages...",
    searchNoResults: "No matching messages",
    searchEmptyTitle: "No matching messages",
    searchEmptyBody: "Try a different keyword or clear the current search: {query}",
    ...
    inputPlaceholderWithAttachments: "Add a message or paste more images...",
    inputPlaceholderMessage: "Message {name} (Enter to send)",
    inputPlaceholderDisconnected: "Connect to the gateway to start chatting...",
    ...
    deleteRemember: "Don't ask again",
    cancel: "Cancel",
    ...
    toolsMore: "{names} +{count} more",
    jsonArray: "Array ({count} item)",
    jsonArrayPlural: "Array ({count} items)",
    jsonObject: "Object ({count} keys)",
    jsonLiteral: "JSON",
